...
func (s Status) BotTokenError() string {
	if s.F_1__ == nil {
		panic("unexpected nil case; should have been checked")
	}
	if s.Sc != StatusCode_BOT_TOKEN_ERROR {
		panic(fmt.Sprintf("unexpected switch value (%v) when BotTokenError is called", s.Sc))
	}
	return *s.F_1__
}
...
func NewStatusWithBotTokenError(v string) Status {
	return Status{
		Sc:    StatusCode_BOT_TOKEN_ERROR,
		F_1__: &v,
	}
}
