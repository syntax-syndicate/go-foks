...
require (
	...
	github.com/foks-proj/go-snowpack-compiler v0.0.5 // indirect
	github.com/foks-proj/go-tools v0.0.4 // indirect
...
tool (
	...
	github.com/foks-proj/go-snowpack-compiler/snowpc
